...
namespace ego_planner
{
  ...
  enum FSM_EXEC_STATE
    ...
    bool callReboundReplanForCable(bool have_local, double start_time);
    ...
    void plotfigure(const ros::TimerEvent &e);
    void odometryCallback(const nav_msgs::OdometryConstPtr &msg);

    void polyTraj2ROSMsg(traj_utils::PolyTraj &msg);
    void polyTraj2ROSMsg1(traj_utils::PolyTraj &msg);
    void polyTraj2ROSMsg2(traj_utils::PolyTraj &msg);
    void polyTraj2ROSMsg3(traj_utils::PolyTraj &msg);
    void polyTraj2ROSMsg4(traj_utils::PolyTraj &msg);
